...
GolemMaterialBase::GolemMaterialBase(const InputParameters & parameters)
  : Material(parameters),
    ...
    _rho0_f(getParam<Real>("initial_density_fluid")),
    _rho0_s(getParam<Real>("initial_density_solid")),
    _phi0(getParam<Real>("initial_porosity")),
    _has_gravity(getParam<bool>("has_gravity")),
    _g(getParam<Real>("gravity_acceleration")),
    _scaling_factor0(getParam<Real>("initial_scaling_factor")),
    _alpha_T_f(getParam<Real>("thermal_expansion_fluid")),
    _alpha_T_s(getParam<Real>("thermal_expansion_solid")),
